...
import { Home, MapPin, DollarSign, Bed, Bath, Maximize, Search, SlidersHorizontal } from 'lucide-react';
...
export default function ResidentialPropertiesPage() {
  ...
  const fetchProperties = async () => {
    try {
      // Fetch both villa and apartment types (residential properties)
      const response = await fetch('/api/properties?limit=100');
      const data = await response.json();
      // Filter for residential types (villa, apartment, or Residential)
      const residentialTypes = ['villa', 'apartment', 'Residential', 'residential'];
  ...
  const filteredProperties = properties.filter(property => {
    ...
    const matchesPrice = priceRange === 'all' || 
      ...
      (priceRange === 'over-2m' && property.price >= 2000000);
    ...
    const matchesBedrooms = bedrooms === 'all' ||
      ...
      (bedrooms === '4+' && (property.bedrooms || 0) >= 4);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge variant="secondary" className="text-sm">Residential Properties</Badge>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Find Your Dream Home
            </h1>
            <p className="text-xl text-muted-foreground mb-8">
              Explore luxury homes, apartments, condos, and townhouses in prime locations. Your perfect residence awaits.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let our experienced team help you discover the ideal residential property that matches your lifestyle and budget.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" asChild>
              <Link to="/for-investors">Investment Opportunities</Link>
            </Button>
          </div>
        </div>
      </section>
