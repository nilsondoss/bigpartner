...
import { Key, MapPin, DollarSign, Bed, Bath, Maximize, Search, SlidersHorizontal } from 'lucide-react';
...
export default function RentalPropertiesPage() {
  ...
  const fetchProperties = async () => {
    try {
      ...
      // API already filters by property type
  ...
  const filteredProperties = properties.filter(property => {
    ...
    const matchesPrice = priceRange === 'all' || 
      (priceRange === 'under-1k' && property.price < 1000) ||
      (priceRange === '1k-2k' && property.price >= 1000 && property.price < 2000) ||
      (priceRange === '2k-3k' && property.price >= 2000 && property.price < 3000) ||
      (priceRange === 'over-3k' && property.price >= 3000);
    ...
    const matchesBedrooms = bedrooms === 'all' ||
      ...
      (bedrooms === '3+' && (property.bedrooms || 0) >= 3);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge variant="secondary" className="text-sm">Rental Properties</Badge>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Find Your Perfect Rental
            </h1>
            <p className="text-xl text-muted-foreground mb-8">
              Browse apartments, houses, and commercial spaces available for rent. Move in today with flexible lease terms.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <Select value={priceRange} onValueChange={setPriceRange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="2k-3k">$2,000 - $3,000/mo</SelectItem>
                <SelectItem value="over-3k">Over $3,000/mo</SelectItem>
              </SelectContent>
            </Select>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-semibold">{formatPrice(property.price)}/mo</span>
                        </div>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Schedule a viewing today and find your next home or business location with flexible lease terms.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" asChild>
              <Link to="/for-partners">List Your Rental</Link>
            </Button>
          </div>
        </div>
      </section>
